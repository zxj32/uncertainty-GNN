...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('dataset', 'ms_academic_phy', 'Dataset string.')  # 'amazon_electronics_photo', 'amazon_electronics_computers', "ms_academic_phy"
flags.DEFINE_string('model', 'S_GCN', 'Model string.')  # 'S_GCN', "S_BGCN"
