...
from utils import *
from models import S_BGCN_T_K, S_BGCN_T, S_GCN
from metrics import *
...
flags.DEFINE_string('model', 'S_BGCN_T_K', 'Model string.')  # 'S_BGCN_T_K'
...
for epoch in range(FLAGS.epochs):
    ...
    # Validation
    cost, acc, duration = evaluate(features, support, y_val, val_mask, epoch, teacher_probability, prior_alpha, placeholders)
    cost_val.append(acc)
